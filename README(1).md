...
| **A. Architha** | SNN Architecture, LIF Neuron Model, Verification |
| **Sarbeswar Dash** | PyTorch Training, Weight Quantisation, Testbench |
| **Xwin J Thomas** | Desktop App, Evaluation Dashboard, Integration |

*M.Tech — Embedded Systems | ECE Department | NIELIT*
